...
# This is a live loop where I have the piano playing continuously
live_loop :melody do
  with_synth x do
    2.times do
      8.times do
...
# This is a live loop that plays the melody from bells from an array
live_loop :bell do
...
# This is a live loop that play a sample at a random sleep time from 10-30
live_loop :sfx do
  sample sfx, amp: 10
  sleep rrand_i(10, 30)
end
